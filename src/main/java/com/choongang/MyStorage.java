...
public class MyStorage {
    ...
    static void prod_input(Scanner s){
        ...
        for(int i = 0; i < products.length; i++) {
            if(products[i].equals(productName)) {
                System.out.println("[Warning] 이미 등록된 제품입니다.");

            } else if(products[i].equals(EMPTY)) {
        ...
        System.out.printf("> %s%n", products[0]);
        System.out.printf("> %s%n", products[1]);
        System.out.printf("> %s%n", products[2]);
        System.out.printf("> %s%n", products[3]);
        System.out.printf("> %s%n", products[4]);
    ...
    static void prod_remove(Scanner s){
        ...
        String productRemove = s.nextLine();

        for(int i = 0; i < products.length; i++) {
            if(productRemove.equals(products[i])) {
                products[i] = EMPTY;
                counts[i] = 0;
            }
        }
    ...
    public static void prod_amount_add(Scanner s) {
        ...
        System.out.printf("> %s : %d개%n", products[0], counts[0]);
        System.out.printf("> %s : %d개%n", products[1], counts[1]);
        System.out.printf("> %s : %d개%n", products[2], counts[2]);
        System.out.printf("> %s : %d개%n", products[3], counts[3]);
        System.out.printf("> %s : %d개%n", products[4], counts[4]);
        System.out.println("-".repeat(30));
    }
    ...
    public static void prod_amount_decrease(Scanner s) {
        ...
        System.out.printf("> %s : %d%n", products[0], counts[0]);
        System.out.printf("> %s : %d%n", products[1], counts[1]);
        System.out.printf("> %s : %d%n", products[2], counts[2]);
        System.out.printf("> %s : %d%n", products[3], counts[3]);
        System.out.printf("> %s : %d%n", products[4], counts[4]);
        System.out.println("-".repeat(30));
        ...
        if(foundIdx < 0) {
            System.out.println("[Warning] 입력한 제품명이 없습니다. 다시 확인하여 주십시오.");
        }
        ...
        try {
            ...
            if(counts[foundIdx] < cnt) {
                System.out.println("[Warning] 입력하신 출고량이 재고량보다 많습니다. 다시 확인하여 주십시오.");
            } else {
